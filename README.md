...
- `/grill-for-unknowns` is an adaptation of the ideas in Matt Pocock's [`grill-with-docs`](https://github.com/mattpocock/skills/blob/main/skills/engineering/grill-with-docs/SKILL.md), [`grilling`](https://github.com/mattpocock/skills/blob/main/skills/productivity/grilling/SKILL.md), and [`domain-modeling`](https://github.com/mattpocock/skills/tree/main/skills/engineering/domain-modeling), combined with Thariq's [“A Field Guide to Fable: Finding Your Unknowns”](https://x.com/trq212/status/2073100352921215386).
