...
- `/efficient-fable` is adapted from Builder.io's public [`efficient-fable` skill](https://github.com/BuilderIO/skills/tree/main/skills/efficient-fable).
- `/calling-claude`, `/implement`, and the goal/gap/orchestration skills are local workflow guidance written for this pack. No gstack provenance was found for them.
